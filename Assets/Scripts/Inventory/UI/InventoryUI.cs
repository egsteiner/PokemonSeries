...
public class InventoryUI : MonoBehaviour
{
    ...
    IEnumerator UseItem()
    {
        ...
        if (usedItem != null)
        {
            if (usedItem is RecoveryItem)
                yield return DialogManager.Instance.ShowDialogText($"Used the {usedItem.Name}");
    ...
    IEnumerator HandleTmItems()
    {
        ...
        else
        {
            ...
            //OLD yield return new WaitUntil(() => state != InventoryUIState.MoveToForget);
            yield return new WaitUntil(() => moveToLearn == null);
        }
    }
