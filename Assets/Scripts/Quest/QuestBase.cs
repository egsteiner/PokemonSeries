...
public class QuestBase : ScriptableObject
    // Have QuestBase and Quest scripts because ScriptableObjects contain static info. bad idea to include dynamically/changing data in here, its in Quest instead
{
